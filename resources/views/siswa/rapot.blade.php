...
<div class="col-md-12">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Student Report Value</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
        @csrf
          ...
          <div class="row">
            ...
            <!-- <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        <h4 class="mb-3">Knowledge and Skills</h4>
                        <table class="table table-bordered table-striped table-hover">
                            <thead>
                                <tr>
                                    <th rowspan="2">No.</th>
                                    <th rowspan="2">Subject</th>
                                    <th rowspan="2">Minimum Passing Mark</th>
