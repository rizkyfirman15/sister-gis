...
@section('heading', 'Value Description / Deskripsi Nilai')
@section('page')
  <li class="breadcrumb-item active">Value Description</li>
@endsection
@section('content')
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <form action="{{ route('nilai.store') }}" method="post">
                    ...
                    @if ($guru->dsk($guru->id))
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nama_gur">Teacher Name / Nama Guru</label>
                                <input type="text" id="nama_gur" name="nama_gur" value="{{ $guru->nama_guru }}" class="form-control" readonly>
                            </div>
                            <div class="form-group">
                                <label for="guru_id">Subject Code / Kode Mapel</label>
            ...
            <div class="card-footer">
                ...
                <button name="submit" class="btn btn-primary"><i class="nav-icon fas fa-save"></i> &nbsp; Save</button>
            </div>
        </form>
    </div>
    <!-- /.card -->
