...
@section('heading', 'Entry Behavior Value / Entry Nilai sikap')
@section('page')
  <li class="breadcrumb-item active">Entry Behavior Value</li>
@endsection
@section('content')
<div class="col-md-12">
          ...
          <div class="row">
            <div class="col-md-12">
                <table class="table" style="margin-top: -10px;">
                    <tr>
                        <td>Class Name / Nama Kelas</td>
                        <td>:</td>
                        <td>{{ $kelas->nama_kelas }}</td>
                    </tr>
                    <tr>
                        <td>Homeroom / Wali Kelas</td>
                        <td>:</td>
                        <td>{{ $kelas->guru->nama_guru }}</td>
                    </tr>
                    <tr>
                        <td>Student Amount / Jumlah Siswa</td>
                        <td>:</td>
                        <td>{{ $siswa->count() }}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Subject Teacher / Guru Mata Pelajaran</td>
                        <td>:</td>
                ...
                <table class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2">Student Name / Nama Siswa</th>
                            <th colspan="3" class="ctr">Behavior Value / Nilai Sikap</th>
                            <th rowspan="2" class="ctr">Action</th>
                        </tr>
                        <tr>
                            <th class="ctr">Friend / Teman</th>
                            <th class="ctr">Alone / Sendiri</th>
                            <th class="ctr">Teacher / Guru</th>
                        </tr>
                    </thead>
                    <tbody>
        ...
        $(".btn_click").click(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    toastr.success("Student attitude score added successfully!");
                    location.reload();
                },
                error: function (data) {
