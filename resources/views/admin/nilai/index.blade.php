...
@section('heading', 'Score Data / Data Nilai')
@section('page')
        ...
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped table-hover">
            <thead>
              <tr>
                <th rowspan="2">No.</th>
                <th rowspan="2" style="width: 15%;">Subject Code</th>
                <th rowspan="2" style="width: 20%;">Subject Teacher</th>
                <th rowspan="2">Minimum Passing Mark</th>
                <th colspan="4" class="text-center">Predicate</th>
              </tr>
              <tr>
                <th>A</th>
                <th>B</th>
