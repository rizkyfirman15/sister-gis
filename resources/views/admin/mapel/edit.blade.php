...
@section('heading', 'Edit Subject / Edit Mapel')
@section('page')
  <li class="breadcrumb-item active"><a href="{{ route('mapel.index') }}">Subject</a></li>
...
<div class="col-md-12">
    ...
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Edit Subject Data</h3>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <select id="kelompok" name="kelompok" class="select2bs4 form-control @error('kelompok') is-invalid @enderror">
                        ...
                        <option value="General Lessons"
                            @if ($mapel->kelompok == 'General Lessons')
                                selected
                            @endif
                        >General Lessons</option>
                        <option value="Special Lessons"
                            @if ($mapel->kelompok == 'Special Lessons')
                                selected
                            @endif
                        >Special Lessons</option>
                        <option value="Expertise Lessons"
                            @if ($mapel->kelompok == 'Expertise Lessons')
                                selected
                            @endif
                        >Expertise Lessons</option>
                    </select>
                </div>
            </div>
          </div>
