        ...
        <div class="card-header">
            <h3 class="card-title">
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target=".tambah-user">
                    <i class="nav-icon fas fa-folder-plus"></i> &nbsp; Add User Data
                </button>
            </h3>
        </div>
        <!-- /.card-header -->
              ...
              <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <select id="role" type="text" class="form-control @error('role') is-invalid @enderror select2bs4" name="role" value="{{ old('role') }}" autocomplete="role">
                    <option value="">-- Select {{ __('User Level') }} --</option>
  ...
  <script>
    $(document).ready(function(){
        $('#role').change(function(){
            ...
            if (kel == "Guru") {
              $("#noId").html('<label for="nomer">Id Card Number</label><input id="nomer" type="text" maxlength="7" onkeypress="return inputAngka(event)" placeholder="No Id Card" class="form-control" name="nomer" autocomplete="off">');
            } else if(kel == "Siswa") {
              $("#noId").html(`<label for="nomer">NIS</label><input id="nomer" type="text" placeholder="No Induk Siswa" class="form-control" name="nomer" autocomplete="off">`);
