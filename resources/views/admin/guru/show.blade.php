...
@section('heading')
  Teacher Data / Data Guru {{ $mapel->nama_mapel }}
@endsection
@section('page')
          ...
          <table id="example1" class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $data->nip }}</td>
                    <td>
                        <a href="{{ asset($data->foto) }}" data-toggle="lightbox" data-title="Foto {{ $data->nama_guru }}" data-gallery="gallery" data-footer='<a href="{{ route('guru.ubah-foto', Crypt::encrypt($data->id)) }}" id="linkFotoGuru" class="btn btn-link btn-block btn-light"><i class="nav-icon fas fa-file-upload"></i> &nbsp; Change Photo</a>'>
