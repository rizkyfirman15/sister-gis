...
@section('heading', 'Change Photo / Ubah Foto')
@section('page')
...
<div class="col-md-12">
    ...
    <div class="card card-primary">
      <div class="card-header">
          <div class="row">
            <div class="col-md-6">
              <h3 class="card-title">Change Photo Form</h3>
            </div>
              <div class="col-md-6">
                <h3 class="card-title">Current Photo</h3>
              </div>
          </div>
      </div>
      <!-- /.card-header -->
      ...
      <form action="{{ route('guru.update-foto', $guru->id) }}"  enctype="multipart/form-data" method="post">
        ...
        <div class="card-footer">
            <a href="{{ route("guru.index") }}" class="btn btn-default"><i class='nav-icon fas fa-arrow-left'></i> &nbsp; Back</a> &nbsp;
