              ...
              <table class="table table-striped table-hover">
                ...
                <tbody id="data-jadwal">
                    ...
                    @if ( $jadwal->count() > 0 )
                      ...
                      <tr>
                        <td colspan='5' style='background:#fff;text-align:center;font-weight:bold;font-size:18px;'>Time for a break!</td>
                      </tr>
                      @else
                  ...
                  @elseif ($jam <= '07:00')
                    <tr>
                      <td colspan='5' style='background:#fff;text-align:center;font-weight:bold;font-size:18px;'>Today's Study Hours Are Starting Soon!</td>
                    </tr>
                @elseif (
                  $hari == '1' && $jam >= '16:15' ||
                  $hari == '2' && $jam >= '16:00' ||
                  ...
                  <tr>
                    <td colspan='5' style='background:#fff;text-align:center;font-weight:bold;font-size:18px;'>Today's Study Hours are Over!</td>
                  </tr>
                @elseif ($hari == '0' || $hari == '6')
                  <tr>
                    <td colspan='5' style='background:#fff;text-align:center;font-weight:bold;font-size:18px;'>School holiday!</td>
                  </tr>
                @elseif($hari == '1' && $jam >= '07:00' && $jam <= '07:30')
                  <tr>
                    <td colspan='5' style='background:#fff;text-align:center;font-weight:bold;font-size:18px;'>Time for the Flag Ceremony!</td>
                  </tr>
                @else
                  <tr>
                    <td colspan='5' style='background:#fff;text-align:center;font-weight:bold;font-size:18px;'>No Schedule Data!</td>
                  </tr>
                @endif
            </tbody>
          </table>
        ...
        setInterval(function() {
          ...
          if (hari == '0' || hari == '6') {
            ...
            if (jam <= '07:00') {
              ...
              $("#data-jadwal").html(
                `<tr>
                  <td colspan='5' style='background:#fff;text-align:center;font-weight:bold;font-size:18px;'>Today's Study Time is Over!</td>
                </tr>`
              );
            } else {
              if (
