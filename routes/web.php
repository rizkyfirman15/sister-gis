...
Route::middleware(['auth'])->group(function () {
  ...
  Route::middleware(['siswa'])->group(function () {
    ...
    Route::get('/syllabus/siswa', 'SyllabusController@indexSiswa')->name('syllabus.siswa');
  });
  ...
  Route::middleware(['guru'])->group(function () {
    ...
    Route::get('/syllabus/guru', 'SyllabusController@indexGuru')->name('syllabus.guru');
    Route::get('/lessonPlan/guru', 'LessonPlanController@index')->name('lessonPlan.guru');
    Route::get('/lessonPlan/guruCreate', 'LessonPlanController@create')->name('lessonPlan.create');
    Route::post('/lessonPlan/guruStore', 'LessonPlanController@store')->name('lessonPlan.store');
    Route::get('/lessonPlan/guruEdit/{id}', 'LessonPlanController@edit')->name('lessonPlan.edit');
    Route::post('/lessonPlan/guruUpdate/{id}', 'LessonPlanController@update')->name('lessonPlan.update');
  });
  ...
  Route::middleware(['admin'])->group(function () {
    ...
    Route::get('/lessonPlan', 'LessonPlanController@indexAdmin')->name('lessonPlan.indexAdmin');
    Route::get('/lessonPlan/create', 'LessonPlanController@createAdmin')->name('lessonPlan.createAdmin');
    Route::post('/lessonPlan/store', 'LessonPlanController@storeAdmin')->name('lessonPlan.storeAdmin');
    Route::get('/lessonPlan/edit/{id}', 'LessonPlanController@editAdmin')->name('lessonPlan.editAdmin');
    Route::post('/lessonPlan/update/{id}', 'LessonPlanController@updateAdmin')->name('lessonPlan.updateAdmin');
    Route::delete('/lessonPlan/destroy/{id}', 'LessonPlanController@destroyAdmin')->name('lessonPlan.destroyAdmin');
  });
});
