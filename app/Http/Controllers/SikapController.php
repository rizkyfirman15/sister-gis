...
class SikapController extends Controller
{
    ...
    public function index()
    {
        ...
        if (
            $guru->mapel->nama_mapel == "Religion / Pendidikan Agama" ||
            $guru->mapel->nama_mapel == "Citizenship Education / Pendidikan Pancasila"
        ) {
    ...
    public function sikap($id)
    {
        ...
        $mapel = Mapel::where('nama_mapel', 'Religion / Pendidikan Agama')->orWhere('nama_mapel', 'Citizenship Education / Pendidikan Pancasila')->get();
